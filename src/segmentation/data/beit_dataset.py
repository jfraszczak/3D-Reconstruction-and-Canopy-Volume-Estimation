...
class BeitDataset(SemanticSegmentationDataset):
    """
    ...
    SegformerImageProcessor has been used as BeitImageProcessor class uses incorrect interpolation method for segmentation maps.
